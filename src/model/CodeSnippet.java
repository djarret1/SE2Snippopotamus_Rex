...
public class CodeSnippet {
	...
	/**
	 * Any ObservableList created with this callback will automatically refresh itself when its
	 * list items change by reading each property in the CodeSnippet that changed. Pass as a parameter to an
	 * ObservableList constructor.
	 ...
	 * @param name The name of the CodeSnippet.
	 * @param description A description of what the CodeSnippet is/does.
	 * @param codeText The actual code stored in the CodeSnippet.
	 */
	 ...
	 * @param name The new name of the CodeSnippet.
	 */
	 ...
	 * @param description The new description of the CodeSnippet.
	 */
	 ...
	 * @param code The new Code object.
	 */
